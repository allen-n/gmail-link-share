...
function showClearConfirmation() {
  ...
  body.textContent =
    "This will permanently delete all saved email link history. This action cannot be undone.";
...
async function init() {
  ...
  convToggle = new ToggleSwitch({
    ...
    description:
      'Show "Copy link" buttons next to each message bubble when viewing conversations',
  ...
  listToggle = new ToggleSwitch({
    ...
    description:
      'Show "Copy link" buttons in your inbox thread list (copies link to last message in thread)',
